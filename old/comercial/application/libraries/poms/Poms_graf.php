...
class Poms_graf {
    ...
    public function setPontuacao($tScore, $rowScore) {
        ...
        $this->tScore->tensao = $tScore->tensao ? $tScore->tensao : 0;
        $this->tScore->depressao = $tScore->depressao ? $tScore->depressao : 0;
        $this->tScore->raiva = $tScore->raiva ? $tScore->raiva : 0;
        $this->tScore->vigor = $tScore->vigor ? $tScore->vigor : 0;
        $this->tScore->fadiga = $tScore->fadiga ? $tScore->fadiga : 0;
        $this->tScore->confusao = $tScore->confusao ? $tScore->confusao : 0;

        $this->rowScore->tensao = $rowScore->tensao ? $rowScore->tensao : 0;
        $this->rowScore->depressao = $rowScore->depressao ? $rowScore->depressao : 0;
        $this->rowScore->raiva = $rowScore->raiva ? $rowScore->raiva : 0;
        $this->rowScore->vigor = $rowScore->vigor ? $rowScore->vigor : 0;
        $this->rowScore->fadiga = $rowScore->fadiga ? $rowScore->fadiga : 0;
        $this->rowScore->confusao = $rowScore->confusao ? $rowScore->confusao : 0;
    }
