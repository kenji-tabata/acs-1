                ...
                <tbody>
                    ...
                    <?php foreach ($pesquisados as $pesquisado): ?>
                        <tr class="<?php echo alternator('', 'zebra') ?> ">
                            ...
                            <td title="<?php echo $pesquisado->nome  ?>"><?php echo string_limiter($pesquisado->nome,  15) ?></td>
                            <td title="<?php echo $pesquisado->email ?>"><?php echo string_limiter($pesquisado->email, 15) ?></td>
                            <td><?php echo $pesquisado->cpf     ?></td>
                            <td title="<?php echo $pesquisado->sexo ?>"><?php echo string_limiter($pesquisado->sexo, 3) ?></td>
