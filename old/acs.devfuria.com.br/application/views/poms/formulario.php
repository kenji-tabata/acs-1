                                                    ...
                                                    <?php foreach ($adjetivos_nomes as $adjetivo_nr => $adjetivo_nome): ?>
                                                            ...
                                                            <?php echo ($i++ % 22 == 0) ? '<div id="col'.$nr_coluna++.'">' : '' ?>
                                                                <div class="adjetivo-poms" id="<?php echo $adjetivo_nome ?>">
                                                                    ...
                                                                    <input type="text" id="valor-<?php echo $adjetivo_nome ?>" class="valor-adjetivo-poms" name="<?php echo $adjetivo_nr ?>" value="<?php echo isset($poms_pesquisado->str_resultado[$adjetivo_nr]) ? $poms_pesquisado->str_resultado[$adjetivo_nr] : '0' ?>" />
                                                                </div>
                                                    <?php endforeach; ?>
                                                </div>
                                                <!-- end div#adjetivos -->
